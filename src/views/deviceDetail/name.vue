<template>
    <div class="container">
        ...
        <div class="deviceDetail-title">
            <div class="import">
                <input class="deviceDetail-text" type="text" placeholder="请输入设备名称" v-model="val" />
        ...
        methods: {
            ...
            saveChange() {
                ...
                this._post("/api/Common/UpdateFieldValue",
                    { table: 'device', fileName: 'Name', fileValue: this.val, byField: 'DeviceId', byFieldValue: this.id },
                    res => {
